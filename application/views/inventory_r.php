	...
	<div id="registry-container" class="card shadow mb-4 table-container registry">
		...
		<div id = "card-body" class="card-body">
			<div id = "table-responsive" class="table-responsive">
				...
				//iprint_r($tablearray);
				$dataarray = $this->Inventory_model->inventory_r_view($metatemplate, $regtab, $tablearray, $wah);
				...
				$genfields = $tablearray['inventory_list']['fields'];
				...
				if(isset($dataarray['ilid'])){
					...
					$attr = array(
						'name'  => 'ilid',
						'id'    => 'ilid',
						'class' => 'form-control ilid',
						'hidden' => true,
						'value' => $dataarray['ilid'],
					);
