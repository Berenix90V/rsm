...
<div class="container-fluid">
    ...
    <a href="<?php echo site_url('Requests/batch_requests_choose_wah'); ?>" class="btn btn-primary btn-icon-split addnew-btn button-margin">
		<span class="icon text-white-50">
			<i class="fas fa-angle-left"></i>
		</span>
		<span class="text">Magazzino</span>
	</a>
