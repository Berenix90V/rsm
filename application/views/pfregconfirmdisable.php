...
<div class="container-fluid">
    ...
    <a href="<?php echo site_url('Pfregistry/pfregistry_view'); ?>" class="btn btn-primary btn-icon-split addnew-btn button-margin">
    ...
    <div id = "card-header-shadow" class="card shadow mb-4">
        <!-- titolo tabella/ form -->
            <div id = "card-body" class="card-body py-3">
                ...
                <a href="<?php echo site_url('Pfregistry/pfregistry_view'); ?>" class="btn btn-primary">
                    <span class="text">No</span>
	            </a>
                <a href="<?php echo site_url('Pfregistry/pfregistry_disable?ref='.$ref); ?>" class="btn btn-primary">
